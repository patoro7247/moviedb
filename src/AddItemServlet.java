...
@WebServlet(name = "AddItemServlet", urlPatterns = "/api/shoppingcart/add")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        for(int i = 0; i < cart.size(); i++){
            if (cart.get(i).getTitle().equals(title)){
                ...
                responseJsonObject.addProperty("message", title+" quantity increased, total quantity: "+cart.get(i).getQuantity());
